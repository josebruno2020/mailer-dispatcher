<div>
    ...
    <x-content>
        <div class="grid grid-cols-2 md:grid-cols-4 space-y-4 md:space-y-0 gap-6 border dark:border-gray-700 border-gray-300 rounded-lg p-4 bg-white dark:bg-gray-800">
            <div>
                <x-label for="setting" value="Setting" />
                <a class="mt-1 text-sm text-gray-600 dark:text-gray-400" href="{{ route('settings.create', ['id' => $email->setting->id]) }}">
                    {{ $email->setting->name }}
                </a>
            </div>
            <div>
                <x-label for="template" value="Template" />
                <a class="mt-1 text-sm text-gray-600 dark:text-gray-400" href="{{ route('templates.create', ['id' => $email->template->id]) }}">
                    {{ $email->template->name }}
                </a>
            </div>
            <div>
        ...
        <div>
            ...
            <div class="mt-1 text-sm text-red-600 dark:text-red-400 border dark:border-gray-700 border-gray-300 rounded-lg p-4 bg-white dark:bg-gray-800">
        ...
        <div class="mt-6">
            ...
            <div class="mt-1 text-sm text-gray-600 dark:text-gray-400 border dark:border-gray-700 border-gray-300 rounded-lg p-4 bg-white dark:bg-gray-800">
                {!! $email->body !!}
            </div>
        </div>
